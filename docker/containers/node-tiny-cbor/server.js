/**
 * CBOR Test Container - Node.js with tiny-cbor library
 */
...
function decodeHex(hexString) {
  ...
  try {
    ...
    const result = tinyCbor.decodeFirstSync(bytes);
...
function encodeValue(value) {
  ...
  try {
    ...
    const encoded = tinyCbor.encode(jsValue);
