/**
 * CBOR Test Container - Node.js with cbor-sync library
 */
...
const PORT = 8080;
const LIBRARY_NAME = 'cbor-sync';
const LIBRARY_VERSION = '1.0.4';
...
function toJsonSafe(value) {
  ...
  // Handle cbor-sync Tagged values
...
function encodeValue(value) {
  ...
  try {
    ...
    const encoded = cbor.encode(jsValue);
