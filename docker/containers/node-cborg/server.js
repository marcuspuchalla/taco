/**
 * CBOR Test Container - Node.js with cborg library (ESM)
 */
...
const PORT = 8080;
const LIBRARY_NAME = 'cborg';
const LIBRARY_VERSION = '4.2.18';
...
function decodeHex(hexString) {
  ...
  try {
    ...
    const result = cborg.decode(bytes);
...
function encodeValue(value) {
  ...
  try {
    ...
    const encoded = cborg.encode(jsValue);
